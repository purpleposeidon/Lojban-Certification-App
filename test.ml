...
SET: FOO barrrr
  The title of this document is "TITLE". The foo variable, which was just defined, is actually written, uh, F O O, but without the spaces. It can't be escaped, it'd take too much effort to setup. But anyways, its value is 'FOO', alright?
